...
@tool   
def generate_visuals(output_path: str):
    """This tool generates images from the video script generated by generate_video_script().
    
    This tool takes the output dictionary from generate_video_script() and creates images for each
    ...
    pipe = pipe.to(device)
    project_dir = os.path.join(output_path, "images")
